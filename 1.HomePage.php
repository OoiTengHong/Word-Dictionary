	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      ...
	      <div class="carousel-caption d-none d-md-block">
		    ...
		    <p>This is slider one item</p> -->
		  </div>
	    </div>
	    <div class="carousel-item">
	      <img src="images/quote.jpg" class="d-block w-100" alt="...">
	      <div class="carousel-caption d-none d-md-block">
		    <!-- <h5>Slider Two Item</h5>
		    <p>This is slider two item</p> -->
		  </div>
	    </div>
	    <div class="carousel-item">
	      <img src="images/google translate.jpg" class="d-block w-100" alt="...">
	      <div class="carousel-caption d-none d-md-block">
		    <!-- <h5>Slider Three Item</h5>
		    <p>This is slider three item</p> -->
		  </div>
	    </div>
	  </div>
